...
- [ ] `MapRendererCore.ts` created in `src/engine/rendering/`
- [ ] Loads maps using MapLoaderRegistry (auto-detects format)
- [ ] Renders terrain using TerrainRenderer
- [ ] Renders units using UnitRenderer
- [ ] Integrates Phase 2 systems (lighting, weather, particles)
- [ ] Applies map environment settings (fog, lighting, ambient)
- [ ] Camera initialization (position, bounds, controls)
- [ ] Disposal system (cleanup on map unload)
- [ ] Registered in rendering/index.ts
